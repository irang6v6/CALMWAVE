    ...
    <div ref={props.refVal} className={`${styles["container"]}`}>
      <div className={`${styles["inner"]}`}>
        ...
        <div className={`${styles["left-box"]}`}>
          ...
          <p className={`${styles["alert-text"]}`}>당신의 일상에 CALM하게 스며들어<br/>
          건강까지 챙겨주는 알림 서비스
          </p>
        </div>
        ...
        <div className={`${styles["right-box"]}`}>
          ...
          <div className={`${styles["alert-wrap"]}`}>
            ...
            <div className={`${styles["alert-box"]}`}>띵동! 스트레칭 할 시간이예요 ~</div>
            <div className={`${styles["alert-box"]}`}>표정이 안 좋아요! 잠시 쉬어가요</div>
          </div>
        </div>
      </div>
