...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthorizationFilter(String secret, AuthenticationManager authenticationManager, UserRepository userRepository, RefreshTokenRepository refreshTokenRepository) {
...
//        super.doFilterInternal(request, response, chain);
        ...
        if (JwtUtil.tokenValidation(secret,a_token)) {
            ...
            if (refreshTokenRepository.findByUsername(username).get().getRefreshToken().equals(r_token)) {
